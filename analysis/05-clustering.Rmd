...
```{r}
var <- c("cluster_walktrap", "sum", "detected", "subsets_EGFP_percent")
```
...
```{r}
var <- c("cluster_louvain", "sum", "detected", "subsets_EGFP_percent")
```
...
```{r}
var <- c("cluster_kmeans", "sum", "detected", "subsets_EGFP_percent")
```
...
```{r}
var <- c("cluster_hclust", "sum", "detected", "subsets_EGFP_percent")
```
