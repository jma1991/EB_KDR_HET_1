...
hvg <- getTopHVGs(dec, var.field = "bio", var.threshold = 0, fdr.threshold = 0.05)
...
hvg <- getTopHVGs(dec, var.field = "ratio", var.threshold = 1, fdr.threshold = 0.05)
...
```{r}
dec <- c("modelGeneVar", "modelGeneCV2", "modelGeneVarByPoisson")
```
