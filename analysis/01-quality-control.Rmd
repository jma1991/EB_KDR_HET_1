...
wrap_plots(
  ...
  plotColData(sce, "altexps_EGFP_percent") + ggtitle("EGFP percent")
)
```
...
patchwork::wrap_plots(
  ...
  plotPCA(sce, colour_by = "altexps_EGFP_percent") + ggtitle("EGFP percent"),
  ncol = 2
)
```
...
patchwork::wrap_plots(
  ...
  plotTSNE(sce, colour_by = "altexps_EGFP_percent") + ggtitle("EGFP percent"),
  ncol = 2
)
```
...
patchwork::wrap_plots(
  ...
  plotUMAP(sce, colour_by = "altexps_EGFP_percent") + ggtitle("EGFP percent"),
  ncol = 2
)
```
...
```{r}
dat <- DataFrame(
  low_lib_size = sce$sum < 3000,
  low_n_features = sce$detected < 1000,
  high_subsets_MT_percent = sce$subsets_MT_percent > 5
)
...
wrap_plots(
  ...
  plotColData(sce, "altexps_EGFP_percent", colour_by = "manual_discard") + ggtitle("EGFP percent")
)
```
...
patchwork::wrap_plots(
  ...
  plotPCA(sce, colour_by = "altexps_EGFP_percent", shape_by = "manual_discard") + ggtitle("EGFP percent"),
  ncol = 2
)
```
...
patchwork::wrap_plots(
  ...
  plotTSNE(sce, colour_by = "altexps_EGFP_percent", shape_by = "manual_discard") + ggtitle("EGFP percent"),
  ncol = 2
)
```
...
patchwork::wrap_plots(
  ...
  plotUMAP(sce, colour_by = "altexps_EGFP_percent", shape_by = "manual_discard") + ggtitle("EGFP percent"),
  ncol = 2
)
```
...
wrap_plots(
  ...
  plotColData(sce, "altexps_EGFP_percent", colour_by = "adaptive_discard") + ggtitle("EGFP percent")
)
```
...
patchwork::wrap_plots(
  ...
  plotPCA(sce, colour_by = "altexps_EGFP_percent", shape_by = "adaptive_discard") + ggtitle("EGFP percent"),
  ncol = 2
)
```
...
patchwork::wrap_plots(
  ...
  plotTSNE(sce, colour_by = "altexps_EGFP_percent", shape_by = "adaptive_discard") + ggtitle("EGFP percent"),
  ncol = 2
)
```
...
patchwork::wrap_plots(
  ...
  plotUMAP(sce, colour_by = "altexps_EGFP_percent", shape_by = "adaptive_discard") + ggtitle("EGFP percent"),
  ncol = 2
)
```
...
wrap_plots(
  ...
  plotColData(sce, "altexps_EGFP_percent", colour_by = "outlier_discard") + ggtitle("EGFP percent")
)
```
...
patchwork::wrap_plots(
  ...
  plotPCA(sce, colour_by = "altexps_EGFP_percent", shape_by = "outlier_discard") + ggtitle("EGFP percent"),
  ncol = 2
)
```
...
patchwork::wrap_plots(
  ...
  plotTSNE(sce, colour_by = "altexps_EGFP_percent", shape_by = "outlier_discard") + ggtitle("EGFP percent"),
  ncol = 2
)
```
...
patchwork::wrap_plots(
  ...
  plotUMAP(sce, colour_by = "altexps_EGFP_percent", shape_by = "outlier_discard") + ggtitle("EGFP percent"),
  ncol = 2
)
```
